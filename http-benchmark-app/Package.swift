...
let strictConcurrencySettings: [SwiftSetting] = {
    ...
    if strictConcurrencyDevelopment {
        // Use warnings-as-errors to catch concurrency issues early.
...
let package = Package(
    name: "HTTPBenchmarkApp",
    platforms: [
        .macOS(.v14)
    ],
    products: [
        .executable(name: "HTTPBenchmarkApp", targets: ["HTTPBenchmarkApp"])
    ],
    dependencies: [
        // SwiftNIO core packages and extras.
